...
class ApplicationBase(BaseModel):
    ...
    notes: str | None = Field(None, description="Additional notes about the application")
...
class ApplicationUpdate(BaseModel):
    ...
    position: str | None = Field(None, description="Job position title")
    status: str | None = Field(None, description="Application status")
    applied_date: date | None = Field(None, description="Date when application was submitted")
    notes: str | None = Field(None, description="Additional notes about the application")
